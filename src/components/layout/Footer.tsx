      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer"
                className="text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors" aria-label="Pinterest">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                className="text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors" aria-label="Instagram">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer"
                className="text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors" aria-label="TikTok">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34l-.01-8.83a8.18 8.18 0 0 0 4.78 1.52V4.56a4.85 4.85 0 0 1-1-.13z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-sm text-[var(--foreground-muted)]">
              <li><Link href="/shipping" className="hover:text-[var(--foreground)] transition-colors">Shipping Policy</Link></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-sm text-[var(--foreground-muted)]">
              <li><a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--foreground)] transition-colors">Pinterest</a></li>
              ...
              <li><a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--foreground)] transition-colors">TikTok</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[var(--foreground-muted)]">
          ...
          <div className="flex items-center gap-4">
            <Link href="/shipping" className="hover:text-[var(--foreground)] transition-colors">Shipping</Link>
            <Link href="/returns" className="hover:text-[var(--foreground)] transition-colors">Returns</Link>
